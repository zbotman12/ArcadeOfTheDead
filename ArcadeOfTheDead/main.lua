...
local MainSheetOpt =
{
	...
	frames = {
		...
		-------------------------------------------------------------
		--[[28]] { x = 51, y =  70, width = 49, height = 100}, --Megaman
		--[[29]] { x = 101, y = 70, width = 49, height = 100}, --Kirby
		--[[30]] { x = 151, y = 70, width = 49, height = 100}, --Link
		-------------------------------------------------------------
		...
		--------------------------------------------------------------
		--[[70]] { x = 201, y =  70, width = 50, height = 100}, --Mario
